...
WSGI_APPLICATION = 'noirvault.wsgi.application'
...
if not DEBUG:
    if not SECRET_KEY:
        raise ValueError("CRITICAL: SECRET_KEY is missing in production!")
    
    if not os.environ.get('DATABASE_URL'):
        raise ValueError("CRITICAL: DATABASE_URL is missing in production!")
    
    if not STRIPE_PUBLIC_KEY or not STRIPE_SECRET_KEY:
        raise ValueError("CRITICAL: Stripe Keys are missing in production!")
